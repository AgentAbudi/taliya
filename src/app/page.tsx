...
const DHIKR_LIST = [
  {
    id: "astaghfirullah",
    arabic: "Ø£ÙØ³ÙØªÙØºÙÙÙØ±Ù Ù±ÙÙÙÙÙÙ",
    label: "Astaghfirullah",
    meaning: "I seek forgiveness from Allah",
  },
  {
    id: "alhamdulillah",
    arabic: "Ù±ÙÙØ­ÙÙÙØ¯Ù ÙÙÙÙÙÙÙ",
    label: "Alhamdulillah",
    meaning: "All praise is due to Allah",
  },
  {
    id: "subhanallah",
    arabic: "Ø³ÙØ¨ÙØ­ÙØ§ÙÙ Ù±ÙÙÙÙÙÙ",
    label: "SubhanAllah",
    meaning: "Glory be to Allah",
  },
  {
    id: "allahuakbar",
    arabic: "Ù±ÙÙÙÙÙÙ Ø£ÙÙÙØ¨ÙØ±Ù",
    label: "Allahu Akbar",
...
export default function Home() {
  ...
  const cycleDhikr = useCallback((direction: 1 | -1) => {
    setActiveDhikr(
      (prev) => (prev + direction + DHIKR_LIST.length) % DHIKR_LIST.length
    );
  }, []);
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-cream-50 via-cream-100 to-emerald-50 flex flex-col items-center relative overflow-hidden">
      ...
      <header className="w-full max-w-md px-6 pt-8 pb-2 animate-fade-in-up">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-xs text-emerald-600/60 uppercase tracking-wider">
              Today
            </p>
      ...
      {/* Dhikr Selector */}
      <div
        className="w-full max-w-md px-6 mt-4 animate-fade-in-up"
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md px-6 py-8">
        ...
        <p
          className="text-sm text-emerald-600/60 mb-8 animate-fade-in-up"
        ...
        {/* Progress Bar */}
        <div
          className="w-48 md:w-56 mt-8 animate-fade-in-up"
          ...
          {DHIKR_LIST.map((d, i) => (
            <div
              ...
              className={`text-center py-2 rounded-xl transition-all ${
                i === activeDhikr ? "bg-emerald-100/80" : "bg-cream-200/30"
              }`}
            >
